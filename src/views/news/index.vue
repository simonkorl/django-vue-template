<template>
  <div id="news">
    <el-row type="flex" justify="center">
        <img src="@/assets/logo.png" width="30%" height="10%">
    </el-row>
    <el-row type="flex" justify="center">
        <el-col :span="16">
...
export default {
  ...
  methods: {
    ...
    searchClick() {
        ...
        this.$store.dispatch('news/getNews', {keywords: this.dynamicTags})
    },
    handleClose(tag) {
